...
export default () => {
  ...
  return (
    <Header className='greeting__header'>
      <Title className='greeting__title' level={4} style={{ fontWeight: 1000}}>
        ...
        >
          <div className='greeting__notification' style={{ bottom : '7px'}}>
            <Badge count={uncheckedNotificationCount} style={{ bottom : '7px'}}>
              <Avatar
                icon={<BellOutlined />}
